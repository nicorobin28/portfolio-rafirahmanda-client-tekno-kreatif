...
const card = () => {
  ...
  const card: data[] = [
    ...
    },
    {
      ...
      subtitle: "Standardizing icons to help users scan actions faster. ",
    },
    {
      id: 4,
      img: "/home1.png",
      ...
      title: "Build Coupon Platform ",
      subtitle: "Linking promotions across the cellcard ecosystem. ",
    },
    {
      id: 5,
      img: "/home1.png",
      ...
      title: "Design Invoicing SaaS from Scratch",
      subtitle: "Studying competitors to simplify business billing. ",
    },
    {
      id: 6,
      img: "/home1.png",
      ...
      title: "Revamp a Messy Marketing SaaS ",
      subtitle: "Turning dribble-ish UI into a industry standards. ",
    },
    {
      id: 7,
      img: "/home1.png",
      ...
      title: "Create Reusable Landing Pages ",
      subtitle: "Layouting go-to-market categories with single format. ",
    },
    {
      id: 8,
      img: "/home1.png",
      ...
      title: "Strategize a Housing Area Website ",
      subtitle: "Shaping a website to increase awareness and buyer interest. ",
    },
  ];
    ...
    <div className="flex px-4 md:px-[120px] pb-5 ">
      ...
      <main className="grid grid-cols-1 md:grid-cols-4 grid-rows-auto gap-6 justify-center">
        ...
        {card.map((item) => (
          <div
            key={item.id}
            className="hidden md:flex flex-col gap-4 max-w-[236px] cursor-pointer group "
          >
            {/* Image */}

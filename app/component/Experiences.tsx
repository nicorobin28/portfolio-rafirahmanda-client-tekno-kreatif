          ...
          <div key={item.id} className="flex gap-6">
            <div className="w-auto flex flex-col items-center pt-2 gap-2">
              ...
              {index !== experience.length - 1 && (
                <div className="w-[2px] md:w-[3px] h-full bg-[#E3E3E4]"></div>
              )}
            </div>
            <div className="flex flex-col gap-[4px]">
              <h1 className="text-[#171718] text-[16px] md:text-[20px] font-medium font-jakarta">
                {item.company}
              </h1>
              <div className="flex flex-wrap items-center gap-[6px] pb-[20px]">
